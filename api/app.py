...
def generar_respuesta_natural(pregunta_usuario, resultados_db):
    ...
    4. No menciones "SQL" ni "Query" a menos que sea necesario. Habla en lenguaje natura
...
def generar_respuesta_natural(pregunta_usuario, resultados_db):
    ...
    2. Debes responder a la pregunta basándote EXCLUSIVAMENTE en los datos proporcionados.
    3. Si los datos están vacíos, di amablemente que no encontraste información.
    4. No menciones "SQL" ni "Query" ni "ID" a menos que sea necesario. Habla en lenguaje natura
    5. Si hay muchos datos, resume los hallazgos principales.
    6. Si te piden una visualización o gráfico, ignora esa parte y céntrate en dar una respuesta textual clara. No menciones la petición ni nada relaccionado con graficos.
    """
